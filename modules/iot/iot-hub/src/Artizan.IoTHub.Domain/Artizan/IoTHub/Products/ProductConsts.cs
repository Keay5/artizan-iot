...
public static class ProductConsts
{
    ...
    /// </summary>
    public const string ProductKeyRegexPattern = Artizan.IoT.Products.ProductConsts.ProductKeyRegexPattern;
    /// <summary>
    /// 产品Key正则验证实例
    /// 参数： RegexOptions.Compiled:（预编译，重复使用高效
    /// </summary>
    public static readonly Regex ProductKeyRegex = Artizan.IoT.Products.ProductConsts.ProductKeyRegex;
