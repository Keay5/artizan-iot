...
public class MqttConnectionService : MqttServiceBase, IMqttConnectionService, ISingletonDependency
{
    ...
    protected MqttDeviceAuthManager MqttDeviceAuthManager { get; }
    ...
    public MqttConnectionService(
        ...
        MqttDeviceAuthManager mqttDeviceAuthManager,
    ...
    private async Task ExecuteAuthenticationWithCircuitBreakerAsync(ValidatingConnectionEventArgs eventArgs, MqttAuthParams authParams, string thingIdentifier, string trackId)
    {
        ...
        try
        {
            ...
            var authResult = await circuitBreaker.ExecuteAsync(async () =>
            {
                ...
                return await MqttDeviceAuthManager.ValidateMqttSignAsync(eventArgs.ClientId, eventArgs.UserName, eventArgs.Password);
            });
