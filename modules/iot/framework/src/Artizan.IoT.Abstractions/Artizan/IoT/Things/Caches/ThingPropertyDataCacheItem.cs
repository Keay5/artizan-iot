...
public class ThingPropertyDataCacheItem
{
    ...
    /// </summary>
    public long Version { get; set; } = new DateTimeOffset(DateTime.UtcNow).ToUnixTimeMilliseconds();
    ...
    /// <returns></returns>
    public static string CalculateAllHistoryDataCacheKey()
    {
        return $"thing:cache:history:";
    }
