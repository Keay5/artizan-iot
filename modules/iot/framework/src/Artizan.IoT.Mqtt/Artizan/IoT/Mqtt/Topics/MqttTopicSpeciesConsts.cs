...
namespace Artizan.IoT.Mqtt.Topics;
...
public static class MqttTopicSpeciesConsts
{
    ...
    public static class ThingModelCommunication
    {
        ...
        public static class PropertyReport
        {
            ...
            /// <summary>
            /// 设备发布：设备属性上报：/sys/${productKey}/${deviceName}/thing/event/property/post
            /// </summary>
            public const string Post = Default + "/post";
            /// <summary>
            /// 设备订阅：云端响应属性上报：/sys/${productKey}/${deviceName}/thing/event/property/post_reply
            /// </summary>
